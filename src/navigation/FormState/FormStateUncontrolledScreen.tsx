...
const StyledSlideTitle = styled(SlideTitle)`
  grid-column: 1 / -1;
`;
export const FormStateUncontrolledScreen = () => {
  useSlide(true);
  ...
  return (
    <Container>
      <StyledSlideTitle>Uncontrolled example</StyledSlideTitle>
      <FormContainer onSubmit={onSubmit}>
        <label htmlFor="text">
          Text:
          <input type="text" id="text" name="text" ref={text} />
        </label>
        <label htmlFor="checkbox">
          Checkbox:
          <input type="checkbox" name="checkbox" id="checkbox" ref={checkBox} />
        </label>
        <label htmlFor="radio">
          Radio:
          <input type="radio" id="radio1" name="radio" value="1" ref={radio} />
          <input type="radio" id="radio2" name="radio" value="2" ref={radio} />
          <input type="radio" id="radio3" name="radio" value="3" ref={radio} />
        </label>
        <label htmlFor="time">
          Time:
          <input type="time" id="time" name="time" ref={time} />
        </label>
